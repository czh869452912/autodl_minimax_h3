...
`;
const DELETE_TOOL_DESCRIPTION = context`
...
function createWriteFileTool(backend, options) {
	...
	return tool(async (input, runtime) => {
		...
		schema: z.preprocess(normalizeFilePathInput, z.object({
			...
			content: z.string().describe("The text content to write to the file. This parameter is required.")
		}))
	});
}
/**
...
function createDeleteTool(backend, options) {
	...
	return tool(async (input, runtime) => {
		...
		schema: z.preprocess(normalizeFilePathInput, z.object({ file_path: z.string().describe("Absolute path to the file to delete. Must be absolute, not relative.") }))
	});
}
/**

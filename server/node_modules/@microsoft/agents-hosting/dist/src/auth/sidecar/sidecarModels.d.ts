 ...
 */
export declare const DEFAULT_SIDECAR_BASE_URL = "http://localhost:5178";
/**
 ...
 */
export declare function toSidecarConnectionSettings(config?: AuthConfiguration): ResolvedSidecarConnectionSettings;
/**

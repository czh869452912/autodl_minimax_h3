...
class FileStorage {
     ...
     */
    read(keys) {
        return (0, agents_telemetry_1.trace)(observability_1.StorageTraceDefinitions.read, async ({ record }) => {
     ...
     */
    write(changes) {
        return (0, agents_telemetry_1.trace)(observability_1.StorageTraceDefinitions.write, async ({ record }) => {
     ...
     */
    delete(keys) {
        return (0, agents_telemetry_1.trace)(observability_1.StorageTraceDefinitions.delete, async ({ record }) => {
            record({ keyCount: keys === null || keys === void 0 ? void 0 : keys.length });
            return new Promise((resolve, reject) => {
                if (!keys || keys.length === 0) {

...
const logger = (0, agents_telemetry_1.debug)('agents:file-transcript-logger');
/**
...
class FileTranscriptLogger {
    ...
    async logActivity(activity) {
        ...
        if (activity.type === agents_activity_1.ActivityTypes.Message) {
            const sender = (_j = (_h = (_b = activity.from) === null || _b === void 0 ? void 0 : _b.name) !== null && _h !== void 0 ? _h : (_c = activity.from) === null || _c === void 0 ? void 0 : _c.id) !== null && _j !== void 0 ? _j : (_d = activity.from) === null || _d === void 0 ? void 0 : _d.role;
            logger.debug(`${sender} [${activity.type}] ${activity.text}`);
        }
        else {
            const sender = (_l = (_k = (_e = activity.from) === null || _e === void 0 ? void 0 : _e.name) !== null && _k !== void 0 ? _k : (_f = activity.from) === null || _f === void 0 ? void 0 : _f.id) !== null && _l !== void 0 ? _l : (_g = activity.from) === null || _g === void 0 ? void 0 : _g.role;
    ...
    getTranscriptFile(channelId, conversationId) {
        if (!(channelId === null || channelId === void 0 ? void 0 : channelId.trim())) {
            throw agents_activity_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.ChannelIdRequired);
        }

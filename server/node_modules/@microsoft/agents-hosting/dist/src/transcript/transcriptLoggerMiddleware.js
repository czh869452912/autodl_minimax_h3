...
const appLogger = (0, agents_telemetry_1.debug)('agents:rest-client');
/**
...
class TranscriptLoggerMiddleware {
    ...
    constructor(logger) {
        if (!logger) {
            throw agents_activity_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.TranscriptLoggerInstanceRequired);
        }
        this.logger = logger;
    }
    /**

...
const logger = (0, agents_telemetry_1.debug)('agents:base-adapter');
/**
        ...
        try {
            ...
            if (this.onTurnError) {
                if (err instanceof Error) {
                    ...
                    throw agents_activity_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.UnknownErrorType, undefined, { errorMessage: err.message });
                }
            }
            else {
                throw err;

...
export declare class AgentApplication<TState extends TurnState> {
    ...
    private getTypingTimingOptions;
    ...
    private handleLongRunningCallError;
    private normalizeLongRunningCallError;
    private stringifyThrownValue;
    /**

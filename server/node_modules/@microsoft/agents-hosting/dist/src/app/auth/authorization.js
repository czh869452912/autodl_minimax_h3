...
const logger = (0, agents_telemetry_1.debug)('agents:authorization');
/**
...
class UserAuthorization {
    ...
    async exchangeToken(context, authHandlerId, options) {
        ...
        throw agents_activity_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.InvalidExchangeTokenParameters);
    }
    /**
    ...
    getHandler(id) {
        ...
        if (!handler) {
            throw agents_activity_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.AuthHandlerNotFound, undefined, { handlerId: id });
        }
        return handler;
    }
}

...
class TurnContext {
    ...
    async sendActivities(activities) {
        return (0, agents_telemetry_1.trace)(observability_1.TurnContextTraceDefinitions.sendActivities, async ({ record, actions }) => {
    ...
    set responded(value) {
        if (!value) {
            throw agents_activity_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.CannotSetRespondedToFalse);
        }

...
const logger = (0, agents_telemetry_1.debug)('agents:activity-handler');
/**
...
class ActivityHandler {
    ...
    async run(context) {
        if (!context)
            throw agents_activity_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.MissingTurnContext);
        if (!context.activity)
            throw agents_activity_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.TurnContextMissingActivity);
        if (!context.activity.type)
            throw agents_activity_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.ActivityMissingType);

...
exports.pseudonymizeConversationId = pseudonymizeConversationId;
exports.redactDiagnosticObject = redactDiagnosticObject;
 ...
 */
function pseudonymizeConversationId(conversationId, key) {
    if (!(conversationId === null || conversationId === void 0 ? void 0 : conversationId.trim())) {
        return undefined;
    }
    const trimmedKey = key === null || key === void 0 ? void 0 : key.trim();
    const hmacKey = trimmedKey
        ? (0, utils_1.utf8ToBytes)(trimmedKey)
        : (processLocalKey !== null && processLocalKey !== void 0 ? processLocalKey : (processLocalKey = createProcessLocalKey()));
    const digest = (0, hmac_1.hmac)(sha2_1.sha256, hmacKey, (0, utils_1.utf8ToBytes)(conversationId));
    return `cid_${(0, utils_1.bytesToHex)(digest).slice(0, 32)}`;
}
function createProcessLocalKey() {
 ...
 */
function redactDiagnosticObject(value, diagnosticsPseudonymKey) {
    return redactValue(value, [], diagnosticsPseudonymKey);
}
function redactValue(value, path, diagnosticsPseudonymKey) {
    var _a, _b;
    if (typeof value === 'string') {
        const propertyName = (_a = path.at(-1)) === null || _a === void 0 ? void 0 : _a.toLowerCase();
        const parentPropertyName = (_b = path.at(-2)) === null || _b === void 0 ? void 0 : _b.toLowerCase();
        ...
        if ((propertyName === null || propertyName === void 0 ? void 0 : propertyName.includes('url')) || propertyName === 'uri' || propertyName === 'href') {

 ...
 */
export function createOTelLogger(otelLogs, namespace) {
    return {
...
function createLogger(otelLogs, namespace, level) {
    var _a;
    const logger = otelLogs.logs.getLogger(namespace);
    const _level = (_a = level === null || level === void 0 ? void 0 : level.toLowerCase()) !== null && _a !== void 0 ? _a : 'debug';

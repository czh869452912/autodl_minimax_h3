  ...
  return recordSpan({
    ...
    attributes: selectTelemetryAttributes({
      ...
      attributes: {
        ...
        ...Object.fromEntries(
          Object.entries((_a22 = telemetry == null ? void 0 : telemetry.metadata) != null ? _a22 : {}).map(([key, value]) => [
...
function handleUIMessageStreamFinish({
  ...
  const callOnFinish = async () => {
    ...
    const declaredOutcome = (_a22 = getOutcome == null ? void 0 : getOutcome()) != null ? _a22 : { status: "unknown" };
...
function createStitchableStream() {
  ...
  return {
    ...
    addStream: (innerStream, callbacks) => {
      var _a22;
      if (isCancelled) {
        (_a22 = callbacks == null ? void 0 : callbacks.onCancel) == null ? void 0 : _a22.call(callbacks);
          ...
          try {
            ...
            for (const toolApproval of invalidToolApprovals) {
              toolExecutionStepStreamController == null ? void 0 : toolExecutionStepStreamController.enqueue({
                ...
                toolName: toolApproval.toolCall.toolName,
                input: toolApproval.toolCall.input,
                error: (0, import_provider29.getErrorMessage)(toolApproval.error),
...
function simulateReadableStream({
  ...
  var _a22;
  const delay = (_a22 = _internal == null ? void 0 : _internal.delay) != null ? _a22 : import_provider_utils32.delay;
  let index = 0;
  return new ReadableStream({
    async pull(controller) {

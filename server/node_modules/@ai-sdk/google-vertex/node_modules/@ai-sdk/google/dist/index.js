...
function isRecursiveJSONSchemaReferenceError(error) {
  return import_provider2.UnsupportedFunctionalityError.isInstance(error) && error.functionality.startsWith(recursiveReferenceFunctionalityPrefix);
}
...
var GoogleGenerativeAILanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    for (const part of parts) {
      if ("executableCode" in part && ((_e = part.executableCode) == null ? void 0 : _e.code)) {
        ...
        content.push({
          type: "tool-call",
          toolCallId: (_f = part.functionCall.id) != null ? _f : this.config.generateId(),
    ...
    return {
      content,
      finishReason: isPromptBlocked ? "content-filter" : mapGoogleGenerativeAIFinishReason({
        finishReason: candidate == null ? void 0 : candidate.finishReason,
        hasToolCalls: content.some((part) => part.type === "tool-call")
      }),
      usage: {
        inputTokens: (_h = usageMetadata == null ? void 0 : usageMetadata.promptTokenCount) != null ? _h : void 0,
        outputTokens: (_i = usageMetadata == null ? void 0 : usageMetadata.candidatesTokenCount) != null ? _i : void 0,
        totalTokens: (_j = usageMetadata == null ? void 0 : usageMetadata.totalTokenCount) != null ? _j : void 0,
        reasoningTokens: (_k = usageMetadata == null ? void 0 : usageMetadata.thoughtsTokenCount) != null ? _k : void 0,
        cachedInputTokens: (_l = usageMetadata == null ? void 0 : usageMetadata.cachedContentTokenCount) != null ? _l : void 0
      },
      warnings,
      providerMetadata: {
        google: {
      ...
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            ...
            if (candidate == null) {
              const promptBlockReason2 = (_g = value.promptFeedback) == null ? void 0 : _g.blockReason;
            ...
            if (content != null) {
              const parts = (_i = content.parts) != null ? _i : [];
              for (const part of parts) {
                if ("executableCode" in part && ((_j = part.executableCode) == null ? void 0 : _j.code)) {

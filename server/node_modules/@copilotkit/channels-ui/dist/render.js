...
function expand(node) {
    ...
    if (typeof node.type === "function") {
        const expanded = expand(node.type(node.props));
    ...
    if (isNativeNode(node)) {
        return [
            {
                ...node,
                props: Object.fromEntries(Object.entries(node.props).map(([name, value]) => [
                    name,
...
function expandNativeValue(value) {

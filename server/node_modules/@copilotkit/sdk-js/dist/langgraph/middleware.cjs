...
const require_header_propagation = require('../header-propagation.cjs');
...
const buildMiddlewareInput = (exposeState, a2uiParams) => ({
	...
	wrapModelCall: async (request, handler) => {
		...
		const forwardedHeaders = require_header_propagation.getForwardedHeaders();
...
const createCopilotkitMiddleware = (options = {}) => {
	return (0, langchain.createMiddleware)(buildMiddlewareInput(options.exposeState ?? false, options.a2uiParams));
};
/**

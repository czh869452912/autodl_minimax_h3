...
//#region src/v1-deprecated/service-adapters/groq/groq-adapter.ts
...
var GroqAdapter = class {
	...
	async process(request) {
		...
		let openaiMessages = messages.map((m) => require_utils.convertMessageToOpenAIMessage(m, { keepSystemRole: true }));
		...
		try {
			...
			throw require_error_utils.convertServiceAdapterError(error, "Groq");
		}
...
//# sourceMappingURL=groq-adapter.cjs.map
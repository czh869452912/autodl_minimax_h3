...
//#region src/v1-deprecated/service-adapters/openai/utils.ts
/**
...
function convertActionInputToOpenAITool(action) {
	return {
		...
		function: {
			...
			parameters: (0, _copilotkit_shared.parseJson)(action.jsonSchema, {})
		}
	};
}
...
//#endregion
exports.convertActionInputToOpenAITool = convertActionInputToOpenAITool;
exports.convertMessageToOpenAIMessage = convertMessageToOpenAIMessage;
exports.convertSystemMessageToAssistantAPI = convertSystemMessageToAssistantAPI;
exports.getChatCompletionsForStreaming = getChatCompletionsForStreaming;
exports.limitMessagesToTokenCount = limitMessagesToTokenCount;
exports.retrieveThreadRun = retrieveThreadRun;
exports.submitToolOutputsStream = submitToolOutputsStream;

...
import { coalesceConsecutiveSameRoleMessages, convertActionInputToAnthropicTool, convertMessageToAnthropicMessage, limitMessagesToTokenCount } from "./utils.mjs";
import { randomId, randomUUID } from "@copilotkit/shared";
import { createAnthropic } from "@ai-sdk/anthropic";

//#region src/v1-deprecated/service-adapters/anthropic/anthropic-adapter.ts
...
var AnthropicAdapter = class {
	...
	*/
	...
	async process(request) {
		...
		const limitedMessages = limitMessagesToTokenCount(coalesceConsecutiveSameRoleMessages(messages.map((message) => {

...
declare class IntelligenceAgentRunner extends AgentRunner {
  ...
  private schedulePendingEventRetry;
  private clearPendingEventRetry;
  private schedulePendingEventFlush;
  private clearPendingEventFlush;
  private resetPendingEventRetry;
  private replayPendingEvents;
  private flushPendingEventBatch;
  private retryActiveEventBatch;
  private completeWhenDurable;
  private runnerEventId;
  private runnerEventSeq;
  private supportsRunnerEventBatch;
  private isRetryableJoinError;
  private isPermanentEventFailure;
  private scheduleEventDeadline;
  private failThread;
  private failIfEventDeadlineExceeded;
  private isCurrentThreadState;
  /**

...
import { Channel, ReplyContinuationOptions } from "@copilotkit/channels-core";
 ...
 */
type ActivateChannelEngine = (config: ChannelActivationConfig, channel: Channel) => Promise<ChannelsHandle>;
/**

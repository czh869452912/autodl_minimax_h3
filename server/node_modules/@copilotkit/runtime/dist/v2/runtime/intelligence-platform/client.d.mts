...
import { InspectorMetadataV1 } from "@copilotkit/shared";
...
interface RecallMemoriesResponse {
  memories: MemorySummary[];
}
/**
...
declare class CopilotKitIntelligence {
  ...
  getThreadMessages(params: {
    threadId: string;
    userId: string; /** Internal managed-Channel delivery context for shared Thread access. */
    channelDeliveryId?: string;
  }): Promise<ThreadMessagesResponse>;
  /** @internal Fetches one authorized managed Channel asset for history hydration. */
  ɵgetManagedChannelAsset(assetId: string): Promise<{
    bytes: Uint8Array;
    mimeType?: string;
  }>;
  /**
   ...
   */
  annotate(params: AnnotateParams): Promise<AnnotateResponse>;

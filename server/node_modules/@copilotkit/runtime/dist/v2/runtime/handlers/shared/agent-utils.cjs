...
const require_mcp_apps_servers = require('./mcp-apps-servers.cjs');
...
function configureAgentForRequest(params) {
	...
	if (runtime.mcpApps?.servers?.length) {
		const mcpServers = require_mcp_apps_servers.resolveMcpAppsServers(runtime.mcpApps.servers, agentId);

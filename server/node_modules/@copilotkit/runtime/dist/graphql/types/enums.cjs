...
//#region src/v1-deprecated/graphql/types/enums.ts
...
(0, type_graphql.registerEnumType)(MessageRole, {
	name: "MessageRole",
	description: "The role of the message"
});
(0, type_graphql.registerEnumType)(CopilotRequestType, {
	name: "CopilotRequestType",
	description: "The type of Copilot request"
});
(0, type_graphql.registerEnumType)(ActionInputAvailability, {

...
//#region src/v1-deprecated/graphql/message-conversion/agui-to-gql.ts
...
const warnedContentPartTypes = /* @__PURE__ */ new Set();
function warnUnsupportedContentPart(type) {
	...
	console.warn(`[CopilotKit] Dropping message content part of unsupported type "${label}". Only "text" and "binary" parts are carried through to the client; see https://github.com/CopilotKit/CopilotKit/issues/1748.`);
}

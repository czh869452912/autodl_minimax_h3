...
//#region src/v1-deprecated/lib/integrations/nextjs/app-router.ts
function copilotRuntimeNextJSAppRouterEndpoint(options) {
	...
	return { handleRequest: handle(createCopilotEndpointSingleRoute({
...
//#endregion
export { copilotRuntimeNextJSAppRouterEndpoint };

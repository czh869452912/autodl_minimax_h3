...
const require_runtime_error_reporter = require('../../v2/runtime/core/runtime-error-reporter.cjs');
...
//#region src/v1-deprecated/lib/runtime/copilot-runtime.ts
/**
* <Callout type="info">
...
var CopilotRuntime = class {
	constructor(params) {
		...
		const sharedRuntimeArgs = {
			...
			[require_runtime_error_reporter.runtimeErrorReporterOption]: require_runtime_error_reporter.createRuntimeErrorReporter(params?.onError),
			forwardHeaders: params?.forwardHeaders,
			exposeMemoryRoutes: params?.exposeMemoryRoutes
		};
		if (params?.intelligence !== void 0) this.runtimeArgs = {
			...sharedRuntimeArgs,

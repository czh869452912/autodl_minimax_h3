...
import { CHANNEL_DELIVERY_PROTOCOL, assertDeliveryPacket, } from "./delivery-contracts.js";
const appendPayload = () => ({
...
test("rejects trusted addressing and credentials", () => {
    ...
    expect(() => assertDeliveryPacket(forged)).toThrow("delivery payload is invalid");
});

 ...
 */
export declare function assertValidChannelNames(channels: readonly Channel[]): void;
 ...
 */
export declare function resolveChannelActivationEnv(overrides?: Partial<ChannelActivationEnv>): ChannelActivationEnv;
/**
 ...
 */
export declare function buildChannelActivationMetadata(channels: readonly Channel[], env: ChannelActivationEnv): ChannelActivationMetadata;

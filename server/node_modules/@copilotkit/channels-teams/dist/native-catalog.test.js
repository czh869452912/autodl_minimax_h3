...
import { TEAMS_ACTION_MANIFEST, TEAMS_BODY_MANIFEST, TEAMS_NATIVE_MANIFEST, TEAMS_PREVIEW_MANIFEST, } from "./native-manifest.js";
...
test("every Teams catalog entry serializes with its native discriminator", () => {
    for (const entry of TEAMS_NATIVE_MANIFEST) {
        ...
        const serialized = entry.kind === "action" || entry.component === "RunCommands"
            ? card.actions?.[0]
            : card.body[0];

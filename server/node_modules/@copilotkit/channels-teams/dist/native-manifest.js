...
function entries(rows, kind, preview = false) {
    return rows.map(([component, type, version, childrenSlot]) => ({
        component,
        type,
        kind,
        version,
        propertyVersions: PROPERTY_VERSIONS[component] ?? PROPERTY_VERSIONS[type] ?? {},
...
export const TEAMS_NATIVE_MANIFEST = [
    {

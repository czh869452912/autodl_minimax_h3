(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ?  factory(exports, require('@tanstack/pacer'), require('@ag-ui/client'), require('@copilotkit/shared'), require('rxjs'), require('rxjs/operators'), require('phoenix'), require('zod-to-json-schema'), require('rxjs/fetch')) :
  typeof define === 'function' && define.amd ? define(['exports', '@tanstack/pacer', '@ag-ui/client', '@copilotkit/shared', 'rxjs', 'rxjs/operators', 'phoenix', 'zod-to-json-schema', 'rxjs/fetch'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.CopilotKitCore = {}), global._tanstack_pacer,global.AgUIClient,global.CopilotKitShared,global.rxjs,global.rxjs.operators,global.phoenix,global.zodToJsonSchema,global.rxjs_fetch));
})(this, function(exports, _tanstack_pacer, _ag_ui_client, _copilotkit_shared, rxjs, rxjs_operators, phoenix, zod_to_json_schema, rxjs_fetch) {
	...
	*/
	...
	var IntelligenceAgent = class IntelligenceAgent extends _ag_ui_client.AbstractAgent {
		constructor(config, sharedState = { lastSeenEventIds: /* @__PURE__ */ new Map() }) {
			...
			_defineProperty(this, "canonicalRunId", null);
		...
		*/
		async connectAgent(parameters, subscriber) {
			...
			try {
				...
				const effectiveParameters = (parameters === null || parameters === void 0 ? void 0 : parameters.runId) || !this.canonicalRunId ? parameters : {
					...parameters,
				...
				const source$ = (0, rxjs.defer)(() => this.connect(input)).pipe((0, _ag_ui_client.transformChunks)(this.debugLogger), (0, rxjs_operators.takeUntil)(self.activeRunDetach$));
		...
		*/
		connect(input) {
			...
			return (0, rxjs.defer)(() => this.requestJoinCredentials$("connect", input, replayCursor)).pipe((0, rxjs.switchMap)((credentials) => {
		...
		*/
		...
		normalizeJoinCredentials(payload, input) {
			...
			const realtime = (envelope === null || envelope === void 0 ? void 0 : envelope.realtime) && typeof envelope.realtime === "object" ? envelope.realtime : null;
			if (typeof (envelope === null || envelope === void 0 ? void 0 : envelope.joinToken) !== "string" || !envelope.joinToken) throw new Error("missing joinToken");
			if (typeof (realtime === null || realtime === void 0 ? void 0 : realtime.clientUrl) !== "string" || !realtime.clientUrl) throw new Error("missing realtime.clientUrl");
		...
		observeThread$(input, credentials, options) {
			return this.observeThreadSession$(input, credentials, options).pipe((0, rxjs_operators.catchError)((error) => {
				...
				const replayCursor = this.getReconnectCursor(input);
				return this.requestJoinCredentials$("connect", input, replayCursor).pipe((0, rxjs.switchMap)((refreshedCredentials) => refreshedCredentials === null ? rxjs.EMPTY : this.observeThread$(this.applyCanonicalRunIdentity(input, refreshedCredentials, { fallbackToInputRunId: options.streamMode === "run" }), refreshedCredentials, {
					...options,
					channelMode: "connect",
					replayCursor
				})));
		...
		observeThreadSession$(input, credentials, options) {
			return (0, rxjs.defer)(() => {
				var _options$channelMode, _options$replayCursor;
				let ownSocket = null;
				let ownChannel = null;
				...
				const params = this.createThreadChannelParams(input, (_options$channelMode = options.channelMode) !== null && _options$channelMode !== void 0 ? _options$channelMode : options.streamMode, options.replayCursor);
				...
				const reconnectCursor = this.readDurableEventId((_options$replayCursor = options.replayCursor) !== null && _options$replayCursor !== void 0 ? _options$replayCursor : this.getReconnectCursor(input));
				let latestObservedReplayCursor = null;
				const threadEvents$ = this.observeThreadEvents$(input.threadId, channel$, options).pipe((0, rxjs_operators.tap)((payload) => {
					var _this$readEventId;
					latestObservedReplayCursor = (_this$readEventId = this.readEventId(payload)) !== null && _this$readEventId !== void 0 ? _this$readEventId : latestObservedReplayCursor;
				}), (0, rxjs_operators.share)());
				const replayComplete$ = this.observeControlEvent$(input.threadId, channel$, REPLAY_COMPLETE_EVENT).pipe((0, rxjs_operators.shareReplay)({
					bufferSize: 1,
					refCount: true
				}));
				...
				const streamIdleCompletion$ = options.streamMode === "connect" ? (0, rxjs.merge)((0, rxjs.combineLatest)([replayComplete$.pipe((0, rxjs_operators.take)(1)), streamIdle$.pipe((0, rxjs_operators.take)(1))]), streamIdle$.pipe((0, rxjs_operators.take)(1), (0, rxjs_operators.filter)((payload) => this.canFallbackCompleteConnect(payload, reconnectCursor, latestObservedReplayCursor)), (0, rxjs_operators.delay)(CONNECT_STREAM_IDLE_REPLAY_FALLBACK_MS))).pipe((0, rxjs_operators.take)(1)) : rxjs.EMPTY;
				...
				const terminal$ = (0, rxjs.merge)(threadCompleted$, streamIdleCompletion$);
				return (0, rxjs.merge)(this.joinThreadChannel$(channel$), this.observeSocketHealth$(socket$).pipe((0, rxjs_operators.takeUntil)(terminal$)), threadEvents$.pipe((0, rxjs_operators.takeUntil)(streamIdleCompletion$)), replayComplete$.pipe((0, rxjs_operators.ignoreElements)(), (0, rxjs_operators.takeUntil)(terminal$)), streamIdleCompletion$.pipe((0, rxjs_operators.ignoreElements)(), (0, rxjs_operators.takeUntil)(threadCompleted$))).pipe((0, rxjs_operators.finalize)(() => this.cleanupOwned(ownChannel, ownSocket)));
			});
		}
		...
		*/
		...
		readControlEventId(payload) {
			var _controlPayload$lates;
			if (!payload || typeof payload !== "object") return null;
			const controlPayload = payload;
			const latestEventId = (_controlPayload$lates = controlPayload.latestEventId) !== null && _controlPayload$lates !== void 0 ? _controlPayload$lates : controlPayload.latest_event_id;
		...
		applyCanonicalRunIdentity(input, credentials, options) {
			var _credentials$runId;
			this.threadId = credentials.threadId;
			const runId = (_credentials$runId = credentials.runId) !== null && _credentials$runId !== void 0 ? _credentials$runId : options.fallbackToInputRunId ? input.runId : null;
...
//#region src/agent.ts
	...
	function withAbortErrorHandling(observable) {
		return observable.pipe((0, rxjs_operators.catchError)((error) => {
			if (isZodError(error) || isAbortError$1(error)) return rxjs.EMPTY;
			throw error;
		}));
	}
	...
	var ProxiedCopilotRuntimeAgent = class ProxiedCopilotRuntimeAgent extends _ag_ui_client.HttpAgent {
		constructor(config) {
			var _config$transport, _ref, _config$runtimeAgentI, _ref2, _config$runtimeMode;
			const normalizedRuntimeUrl = config.runtimeUrl ? config.runtimeUrl.replace(/\/$/, "") : void 0;
			const transport = (_config$transport = config.transport) !== null && _config$transport !== void 0 ? _config$transport : "auto";
			const routedId = (_ref = (_config$runtimeAgentI = config.runtimeAgentId) !== null && _config$runtimeAgentI !== void 0 ? _config$runtimeAgentI : config.agentId) !== null && _ref !== void 0 ? _ref : "";
			const runUrl = transport === "single" ? (_ref2 = normalizedRuntimeUrl !== null && normalizedRuntimeUrl !== void 0 ? normalizedRuntimeUrl : config.runtimeUrl) !== null && _ref2 !== void 0 ? _ref2 : "" : `${normalizedRuntimeUrl !== null && normalizedRuntimeUrl !== void 0 ? normalizedRuntimeUrl : config.runtimeUrl}/agent/${encodeURIComponent(routedId)}/run`;
			...
			_defineProperty(this, "runtimeAgentId", void 0);
			...
			this.runtimeMode = (_config$runtimeMode = config.runtimeMode) !== null && _config$runtimeMode !== void 0 ? _config$runtimeMode : _copilotkit_shared.RUNTIME_MODE_SSE;
		...
		*/
		routedAgentId() {
			var _this$runtimeAgentId;
			const id = (_this$runtimeAgentId = this.runtimeAgentId) !== null && _this$runtimeAgentId !== void 0 ? _this$runtimeAgentId : this.agentId;
		...
		async getCapabilities() {
			...
			return (_this$_capabilities = this._capabilities) !== null && _this$_capabilities !== void 0 ? _this$_capabilities : {};
		}
		...
		connect(input) {
			if (this.runtimeMode === "pending" || this.transport === "auto" && this.runtimeMode !== _copilotkit_shared.RUNTIME_MODE_INTELLIGENCE) return (0, rxjs.defer)(() => (0, rxjs.from)(this.ensureRuntimeConfiguration())).pipe((0, rxjs_operators.switchMap)(() => this.connect(input)));
			if (this.runtimeMode === _copilotkit_shared.RUNTIME_MODE_INTELLIGENCE) return _assertClassBrand(_ProxiedCopilotRuntimeAgent_brand, this, _connectViaDelegate).call(this, input);
			return _assertClassBrand(_ProxiedCopilotRuntimeAgent_brand, this, _connectViaHttp).call(this, input);
		}
		run(input) {
			if (this.runtimeMode === "pending" || this.transport === "auto" && this.runtimeMode !== _copilotkit_shared.RUNTIME_MODE_INTELLIGENCE) return (0, rxjs.defer)(() => (0, rxjs.from)(this.ensureRuntimeConfiguration())).pipe((0, rxjs_operators.switchMap)(() => this.run(input)));
			if (this.runtimeMode === _copilotkit_shared.RUNTIME_MODE_INTELLIGENCE) return _assertClassBrand(_ProxiedCopilotRuntimeAgent_brand, this, _runViaDelegate).call(this, input);
		...
		*/
		clearReplayCursor(threadId) {
			var _delegate$clearReconn;
			if (this.runtimeMode !== _copilotkit_shared.RUNTIME_MODE_INTELLIGENCE) return;
			const delegate = this.delegate;
			delegate === null || delegate === void 0 || (_delegate$clearReconn = delegate.clearReconnectCursor) === null || _delegate$clearReconn === void 0 || _delegate$clearReconn.call(delegate, threadId);
		}
		...
		async ensureRuntimeConfiguration() {
			...
			if (this.runtimeMode === _copilotkit_shared.RUNTIME_MODE_INTELLIGENCE || this.runtimeMode !== "pending" && this.transport !== "auto") return;
			if (!this.runtimeUrl) throw new Error("Runtime URL is not set");
			const runtimeInfoPromise = (_this$runtimeInfoProm = this.runtimeInfoPromise) !== null && _this$runtimeInfoProm !== void 0 ? _this$runtimeInfoProm : this.fetchRuntimeInfo().then((runtimeInfo) => {
				var _runtimeInfo$mode;
				this.runtimeMode = (_runtimeInfo$mode = runtimeInfo.mode) !== null && _runtimeInfo$mode !== void 0 ? _runtimeInfo$mode : _copilotkit_shared.RUNTIME_MODE_SSE;
		...
		createIntelligenceDelegate() {
			...
			const routedId = this.routedAgentId();
			if (!this.runtimeUrl || !routedId || !((_this$intelligence = this.intelligence) === null || _this$intelligence === void 0 ? void 0 : _this$intelligence.wsUrl)) throw new Error("Intelligence mode requires runtimeUrl, agentId, and intelligence websocket metadata");
	...
	function _connectViaHttp(input) {
		...
		if (this.transport === "single") {
			...
			return withAbortErrorHandling((0, _ag_ui_client.transformHttpEventStream)((0, _ag_ui_client.runHttpRequest)(() => this.fetch(this.singleEndpointUrl, requestInit))));
		}
		const connectUrl = `${this.runtimeUrl}/agent/${routedId}/connect`;
		const connectRequestInit = this.requestInit(input);
		return withAbortErrorHandling((0, _ag_ui_client.transformHttpEventStream)((0, _ag_ui_client.runHttpRequest)(() => this.fetch(connectUrl, connectRequestInit))));
	}
	...
	*/
	var AgentRegistry = class {
		constructor(core) {
			...
			_defineProperty(this, "_connectionInFlight", void 0);
			...
			_defineProperty(this, "_runtimeTransport", "auto");
			_defineProperty(this, "_requestedTransport", "auto");
			_defineProperty(this, "_audioFileTranscriptionEnabled", false);
			_defineProperty(this, "_runtimeMode", _copilotkit_shared.RUNTIME_MODE_SSE);
			_defineProperty(this, "_intelligence", void 0);
			_defineProperty(this, "_threadEndpoints", void 0);
			_defineProperty(this, "_suggestions", void 0);
			_defineProperty(this, "_inspectorMetadata", void 0);
			_defineProperty(this, "_inspectorMetadataSupported", false);
			_defineProperty(this, "inspectorMetadataRefreshReady", false);
			_defineProperty(this, "inspectorMetadataConnectionGeneration", 0);
			_defineProperty(this, "inspectorMetadataGeneration", 0);
			_defineProperty(this, "inspectorMetadataHeadersGeneration", 0);
			_defineProperty(this, "inspectorMetadataCredentialsGeneration", 0);
			_defineProperty(this, "inspectorMetadataAbortController", void 0);
			_defineProperty(this, "inspectorMetadataNotificationQueue", Promise.resolve());
			_defineProperty(this, "_a2uiEnabled", false);
			_defineProperty(this, "_a2uiAgents", void 0);
			_defineProperty(this, "_openGenerativeUIEnabled", false);
			_defineProperty(this, "_licenseStatus", void 0);
			_defineProperty(this, "_telemetryDisabled", false);
			_defineProperty(this, "agentOwnHeaders", /* @__PURE__ */ new WeakMap());
		}
		/**
		...
		*/
		setRuntimeUrl(runtimeUrl, options) {
			...
			if (options === null || options === void 0 ? void 0 : options.deferConnection) return;
		...
		*/
		async refreshInspectorMetadata() {
			...
			(_this$inspectorMetada = this.inspectorMetadataAbortController) === null || _this$inspectorMetada === void 0 || _this$inspectorMetada.abort();
			...
			const handleAbort = () => {
				rejectForAbort === null || rejectForAbort === void 0 || rejectForAbort(/* @__PURE__ */ new Error("Inspector metadata request aborted"));
			};
			...
			try {
				const request = (async () => {
					...
					return (0, _copilotkit_shared.parseInspectorMetadataV1)(await response.json());
				})();
		...
		invalidateInspectorMetadataConnection() {
			...
			(_this$inspectorMetada2 = this.inspectorMetadataAbortController) === null || _this$inspectorMetada2 === void 0 || _this$inspectorMetada2.abort();
			this.inspectorMetadataAbortController = void 0;
			this.setInspectorMetadata(void 0);
		}
		/**
		...
		*/
		async updateRuntimeConnection() {
			var _this$_runtimeUrl;
			if (typeof window === "undefined") return;
			const key = `${(_this$_runtimeUrl = this._runtimeUrl) !== null && _this$_runtimeUrl !== void 0 ? _this$_runtimeUrl : ""}::${this._requestedTransport}`;
			...
			promise.finally(() => {
				var _this$_connectionInFl;
				if (((_this$_connectionInFl = this._connectionInFlight) === null || _this$_connectionInFl === void 0 ? void 0 : _this$_connectionInFl.promise) === promise) this._connectionInFlight = void 0;
			});
			return promise;
		}
		async performRuntimeConnection() {
			...
			try {
				var _runtimeInfoResponse$2, _runtimeInfoResponse$3, _ref, _a2uiInfo$enabled, _runtimeInfoResponse$4, _runtimeInfoResponse$5;
				...
				this.remoteAgents = Object.fromEntries(Object.entries(runtimeInfo.agents).map(([id, { description, capabilities }]) => {
					...
					const agent = new ProxiedCopilotRuntimeAgent({
						...
						transport: this._runtimeTransport,
						credentials,
						runtimeMode: (_runtimeInfoResponse$ = runtimeInfoResponse.mode) !== null && _runtimeInfoResponse$ !== void 0 ? _runtimeInfoResponse$ : _copilotkit_shared.RUNTIME_MODE_SSE,
				...
				this._runtimeMode = (_runtimeInfoResponse$3 = runtimeInfoResponse.mode) !== null && _runtimeInfoResponse$3 !== void 0 ? _runtimeInfoResponse$3 : _copilotkit_shared.RUNTIME_MODE_SSE;
				...
				this._a2uiEnabled = (_ref = (_a2uiInfo$enabled = a2uiInfo === null || a2uiInfo === void 0 ? void 0 : a2uiInfo.enabled) !== null && _a2uiInfo$enabled !== void 0 ? _a2uiInfo$enabled : runtimeInfoResponse.a2uiEnabled) !== null && _ref !== void 0 ? _ref : false;
				this._a2uiAgents = (a2uiInfo === null || a2uiInfo === void 0 ? void 0 : a2uiInfo.enabled) ? a2uiInfo.agents : void 0;
				this._openGenerativeUIEnabled = (_runtimeInfoResponse$4 = runtimeInfoResponse.openGenerativeUIEnabled) !== null && _runtimeInfoResponse$4 !== void 0 ? _runtimeInfoResponse$4 : false;
				this._licenseStatus = runtimeInfoResponse.licenseStatus;
				this._telemetryDisabled = (_runtimeInfoResponse$5 = runtimeInfoResponse.telemetryDisabled) !== null && _runtimeInfoResponse$5 !== void 0 ? _runtimeInfoResponse$5 : false;
		...
		*/
		...
		async notifyInspectorMetadataChanged(inspectorMetadata) {
			await this.core.notifySubscribers((subscriber) => {
				var _subscriber$onInspect;
				return (_subscriber$onInspect = subscriber.onInspectorMetadataChanged) === null || _subscriber$onInspect === void 0 ? void 0 : _subscriber$onInspect.call(subscriber, {
					copilotkit: this.core,
					inspectorMetadata
				});
	...
	var SuggestionEngine = class {
		...
		*/
		reloadSuggestions(agentId) {
			...
			const messageCount = (_agent$messages$lengt = agent === null || agent === void 0 || (_agent$messages = agent.messages) === null || _agent$messages === void 0 ? void 0 : _agent$messages.length) !== null && _agent$messages$lengt !== void 0 ? _agent$messages$lengt : 0;
		...
		*/
		async generateSuggestions(suggestionId, config, consumerAgentId) {
			...
			let aborted = false;
			try {
				var _config$providerAgent, _config$minSuggestion, _config$maxSuggestion, _suggestionsConsumerA, _this$_runningSuggest3;
				const friends = this.core;
				const resolvedProviderAgentId = (_config$providerAgent = config.providerAgentId) !== null && _config$providerAgent !== void 0 ? _config$providerAgent : "default";
				...
				const seededState = JSON.parse(JSON.stringify((_suggestionsConsumerA = suggestionsConsumerAgent.state) !== null && _suggestionsConsumerA !== void 0 ? _suggestionsConsumerA : {}));
				...
				if (useStateless) {
					...
					const credentials = this.core.credentials;
					suggestionAgent = new _ag_ui_client.HttpAgent({
				...
				this._runningSuggestions[consumerAgentId] = [...(_this$_runningSuggest3 = this._runningSuggestions[consumerAgentId]) !== null && _this$_runningSuggest3 !== void 0 ? _this$_runningSuggest3 : [], runHandle];
				...
				const remaining = runHandle ? (runningAgents !== null && runningAgents !== void 0 ? runningAgents : []).filter((a) => a !== runHandle) : runningAgents !== null && runningAgents !== void 0 ? runningAgents : [];
		...
		*/
		finalizeSuggestions(suggestionId, consumerAgentId) {
			...
			if (agentSuggestions && currentSuggestions && currentSuggestions.length > 0) {
				...
				const allSuggestions = Object.values((_this$_suggestions$co = this._suggestions[consumerAgentId]) !== null && _this$_suggestions$co !== void 0 ? _this$_suggestions$co : {}).flat();
...
/**
	...
	*/
	var RunHandler = class {
		constructor(core) {
			...
			_defineProperty(this, "_catalogComponents", []);
			_defineProperty(this, "_disabledCatalogComponents", /* @__PURE__ */ new Set());
			_defineProperty(this, "_disabledToolKeys", /* @__PURE__ */ new Set());
			_defineProperty(this, "_runAbortController", null);
			_defineProperty(this, "_runDepth", 0);
			_defineProperty(this, "_lastConnectedThreadIdsByAgent", /* @__PURE__ */ new Map());
			_defineProperty(this, "_anonymousAgentIds", /* @__PURE__ */ new WeakMap());
			_defineProperty(this, "_nextAnonymousAgentId", 0);
		}
		/**
		...
		*/
		async connectAgent({ agent }) {
			var _agent$threadId;
			const incomingThreadId = (_agent$threadId = agent.threadId) !== null && _agent$threadId !== void 0 ? _agent$threadId : null;
			try {
				var _this$_lastConnectedT;
				const restoreKey = this.getConnectRestoreKey(agent);
				const isFreshRestore = incomingThreadId !== ((_this$_lastConnectedT = this._lastConnectedThreadIdsByAgent.get(restoreKey)) !== null && _this$_lastConnectedT !== void 0 ? _this$_lastConnectedT : null);
				...
				await this._internal.notifySubscribers((subscriber) => {
					var _subscriber$onAgentRu;
					return (_subscriber$onAgentRu = subscriber.onAgentRunStarted) === null || _subscriber$onAgentRu === void 0 ? void 0 : _subscriber$onAgentRu.call(subscriber, {
						copilotkit: this.core,
						agent
					});
		...
		*/
		async runAgent({ agent, forwardedProps, resume, runId }, continuationHandoff) {
			...
			if (agent.detachActiveRun) try {
				...
				continuationHandoff === null || continuationHandoff === void 0 || continuationHandoff.cancel();
				throw error;
			}
			...
			if (isTopLevel) {
				...
				await this._internal.notifySubscribers((subscriber) => {
					var _subscriber$onAgentRu2;
					return (_subscriber$onAgentRu2 = subscriber.onAgentRunStarted) === null || _subscriber$onAgentRu2 === void 0 ? void 0 : _subscriber$onAgentRu2.call(subscriber, {
						copilotkit: this.core,
						agent
					});
				}, "Subscriber onAgentRunStarted error:");
			...
			try {
				...
				agentSubscriber.onRunInitialized = async (params) => {
					continuationHandoff === null || continuationHandoff === void 0 || continuationHandoff.bind(params.input);
					return onRunInitialized === null || onRunInitialized === void 0 ? void 0 : onRunInitialized(params);
				};
				agentSubscriber.onRunStartedEvent = async (params) => {
					started = true;
					if (!continuationHandoff) logicalRunId = params.input.runId;
					return onRunStartedEvent === null || onRunStartedEvent === void 0 ? void 0 : onRunStartedEvent(params);
				};
				...
				if (!started) continuationHandoff === null || continuationHandoff === void 0 || continuationHandoff.cancel();
		...
		async processAgentResult({ runAgentResult, agent, runId, executeFrontendTools = true }) {
			...
			if (executeFrontendTools) {
				for (const message of newMessages) if (message.role === "assistant") for (const toolCall of message.toolCalls || []) {
					...
					const executableTool = tool !== null && tool !== void 0 ? tool : getWildcardTool();
					if (existingResult && (executableTool === null || executableTool === void 0 ? void 0 : executableTool.handler) && this.isFrontendPlaceholderResult(existingResult)) {
			...
			if (needsFollowUp && !((_this$_runAbortContro2 = this._runAbortController) === null || _this$_runAbortContro2 === void 0 ? void 0 : _this$_runAbortContro2.signal.aborted)) if (this._runDepth >= MAX_FOLLOW_UP_DEPTH) _copilotkit_shared.logger.warn(`[CopilotKit] Follow-up depth limit (${MAX_FOLLOW_UP_DEPTH}) reached for agent "${agentId}". Stopping recursive follow-up runs to prevent an infinite loop. This usually indicates a tool that keeps requesting a follow-up (e.g. the LLM repeatedly calling the same tool). Consider setting "followUp: false" on the offending tool.`);
			else {
		...
		*/
		async executeSpecificTool(tool, toolCall, message, agent, agentId) {
			...
			{
				var _agent$messages$inser;
				const messageIndex = agent.messages.findIndex((m) => m.id === message.id);
				if (messageIndex === -1) return false;
				let insertAt = messageIndex + 1;
				while (insertAt < agent.messages.length && ((_agent$messages$inser = agent.messages[insertAt]) === null || _agent$messages$inser === void 0 ? void 0 : _agent$messages$inser.role) === "tool") insertAt++;
				const toolMessage = {
		...
		*/
		async executeWildcardTool(wildcardTool, toolCall, message, agent, agentId) {
			...
			{
				var _agent$messages$inser2;
				const messageIndex = agent.messages.findIndex((m) => m.id === message.id);
				if (messageIndex === -1) return false;
				let insertAt = messageIndex + 1;
				while (insertAt < agent.messages.length && ((_agent$messages$inser2 = agent.messages[insertAt]) === null || _agent$messages$inser2 === void 0 ? void 0 : _agent$messages$inser2.role) === "tool") insertAt++;
				const toolMessage = {
					id: (0, _copilotkit_shared.randomUUID)(),
					role: "tool",
					toolCallId: toolCall.id,
		...
		*/
		...
		capabilityKey(name, agentId) {
			return `${agentId !== null && agentId !== void 0 ? agentId : ""}\u0000${name}`;
		}
		/**
		...
		createAgentErrorSubscriber(agent) {
			...
			return {
				...
				onRunErrorEvent: async ({ event }) => {
					var _this$_runAbortContro4, _event$rawEvent, _event$rawEvent2, _event$message;
					if (((_this$_runAbortContro4 = this._runAbortController) === null || _this$_runAbortContro4 === void 0 ? void 0 : _this$_runAbortContro4.signal.aborted) === true || (event === null || event === void 0 ? void 0 : event.code) === "abort") return;
	...
	*/
	function createToolSchema(tool) {
		...
		const rawSchema = (0, _copilotkit_shared.schemaToJsonSchema)(tool.parameters, { zodToJsonSchema: (schema, options) => (0, zod_to_json_schema.zodToJsonSchema)(schema, options) });
...
//#region src/core/state-manager.ts
	const isContinuation = (input) => {
		var _command, _input$forwardedProps;
		return input.resume !== void 0 || Object.prototype.hasOwnProperty.call((_command = (_input$forwardedProps = input.forwardedProps) === null || _input$forwardedProps === void 0 ? void 0 : _input$forwardedProps.command) !== null && _command !== void 0 ? _command : {}, "resume");
	};
	/**
	...
	*/
	var StateManager = class {
		constructor(core) {
			...
			_defineProperty(this, "rawEventByMessage", /* @__PURE__ */ new Map());
			_defineProperty(this, "activeRun", /* @__PURE__ */ new Map());
			_defineProperty(this, "agentSubscriptions", /* @__PURE__ */ new Map());
			_defineProperty(this, "pendingContinuations", /* @__PURE__ */ new WeakMap());
		}
		/**
		...
		subscribeToAgent(agent) {
			...
			const reconcilePendingResults = (historyMessages, input) => {
				...
				for (const event of events.values()) {
					var _messages$insertIndex;
					const ownerIndex = messages.findIndex((message) => {
						var _message$toolCalls;
						return message.role === "assistant" && ((_message$toolCalls = message.toolCalls) === null || _message$toolCalls === void 0 ? void 0 : _message$toolCalls.some((toolCall) => toolCall.id === event.toolCallId));
					});
					...
					const realIndex = matchingIndexes.find((index) => {
						var _messages$index;
						return !isForwardedToClientPlaceholder((_messages$index = messages[index]) === null || _messages$index === void 0 ? void 0 : _messages$index.content);
					});
					if (realIndex !== void 0) {
					...
					const placeholderIndex = matchingIndexes.find((index) => {
						var _messages$index2;
						return isForwardedToClientPlaceholder((_messages$index2 = messages[index]) === null || _messages$index2 === void 0 ? void 0 : _messages$index2.content);
					});
					if (placeholderIndex !== void 0) {
						...
						changed = true;
						for (const duplicateIndex of matchingIndexes.filter((candidateIndex) => {
							var _messages$candidateIn;
							return candidateIndex !== placeholderIndex && isForwardedToClientPlaceholder((_messages$candidateIn = messages[candidateIndex]) === null || _messages$candidateIn === void 0 ? void 0 : _messages$candidateIn.content);
						}).sort((a, b) => b - a)) messages.splice(duplicateIndex, 1);
						continue;
					}
					const result = {
						id: event.messageId,
					...
					while (((_messages$insertIndex = messages[insertIndex]) === null || _messages$insertIndex === void 0 ? void 0 : _messages$insertIndex.role) === "tool") insertIndex++;
			...
			const effectiveInput = (input) => {
				...
				return {
					...input,
					runId: (_subRunId = subRunId) !== null && _subRunId !== void 0 ? _subRunId : input.runId
				};
			};
			const { unsubscribe } = agent.subscribe({
				onRunStartedEvent: ({ event, input, state }) => {
					...
					const internalContinuation = [...pendingForAgent !== null && pendingForAgent !== void 0 ? pendingForAgent : []].find((pending) => pending.expectedInput === input);
					internalContinuation === null || internalContinuation === void 0 || internalContinuation.cancel();
					if (internalContinuation) {
						var _ref, _internalContinuation;
						subRunId = (_ref = (_internalContinuation = internalContinuation.expectedRunId) !== null && _internalContinuation !== void 0 ? _internalContinuation : event.runId) !== null && _ref !== void 0 ? _ref : input.runId;
					} else if (runFinished && input.runId === subRunId && !isContinuation(input) && (event.runId == null || event.runId === subRunId)) subRunId = (0, _ag_ui_client.randomUUID)();
		...
		*/
		getRawEventForMessage(agentId, threadId, messageId) {
			var _this$rawEventByMessa;
			const rawEvent = (_this$rawEventByMessa = this.rawEventByMessage.get(agentId)) === null || _this$rawEventByMessa === void 0 || (_this$rawEventByMessa = _this$rawEventByMessa.get(threadId)) === null || _this$rawEventByMessa === void 0 ? void 0 : _this$rawEventByMessa.get(messageId);
			return rawEvent === void 0 ? void 0 : (0, _ag_ui_client.structuredClone_)(rawEvent);
		}
		/**
		...
		*/
		handleTextMessageStart(agent, event, input) {
			...
			if (event.rawEvent === void 0) {
				var _this$rawEventByMessa2, _this$rawEventByMessa4;
				const threadEvents = (_this$rawEventByMessa2 = this.rawEventByMessage.get(agent.agentId)) === null || _this$rawEventByMessa2 === void 0 ? void 0 : _this$rawEventByMessa2.get(threadId);
				threadEvents === null || threadEvents === void 0 || threadEvents.delete(event.messageId);
				if ((threadEvents === null || threadEvents === void 0 ? void 0 : threadEvents.size) === 0) {
					var _this$rawEventByMessa3;
					(_this$rawEventByMessa3 = this.rawEventByMessage.get(agent.agentId)) === null || _this$rawEventByMessa3 === void 0 || _this$rawEventByMessa3.delete(threadId);
				}
				if (((_this$rawEventByMessa4 = this.rawEventByMessage.get(agent.agentId)) === null || _this$rawEventByMessa4 === void 0 ? void 0 : _this$rawEventByMessa4.size) === 0) this.rawEventByMessage.delete(agent.agentId);
				return;
			}
		...
		*/
		handleNewMessage(agent, message, input) {
			...
			if (!input) {
				var _agent$threadId;
				const threadId = (_agent$threadId = agent.threadId) !== null && _agent$threadId !== void 0 ? _agent$threadId : "";
		...
		*/
		...
		pruneRawEvents(agentId, fallbackThreadId, messages, input) {
			var _input$threadId, _this$rawEventByMessa5, _this$rawEventByMessa7;
			const threadId = (_input$threadId = input === null || input === void 0 ? void 0 : input.threadId) !== null && _input$threadId !== void 0 ? _input$threadId : fallbackThreadId;
			if (!threadId) return;
			const threadEvents = (_this$rawEventByMessa5 = this.rawEventByMessage.get(agentId)) === null || _this$rawEventByMessa5 === void 0 ? void 0 : _this$rawEventByMessa5.get(threadId);
			...
			if (threadEvents.size === 0) {
				var _this$rawEventByMessa6;
				(_this$rawEventByMessa6 = this.rawEventByMessage.get(agentId)) === null || _this$rawEventByMessa6 === void 0 || _this$rawEventByMessa6.delete(threadId);
			}
			if (((_this$rawEventByMessa7 = this.rawEventByMessage.get(agentId)) === null || _this$rawEventByMessa7 === void 0 ? void 0 : _this$rawEventByMessa7.size) === 0) this.rawEventByMessage.delete(agentId);
		}
		/**
		...
		*/
		clearThreadState(agentId, threadId) {
			var _this$stateByRun$get4, _this$messageToRun$ge2, _this$rawEventByMessa8;
			...
			(_this$rawEventByMessa8 = this.rawEventByMessage.get(agentId)) === null || _this$rawEventByMessa8 === void 0 || _this$rawEventByMessa8.delete(threadId);
		}
	};
...
//#region src/core/thread-store-registry.ts
	var ThreadStoreRegistry = class {
		constructor(core) {
			this.core = core;
			_defineProperty(this, "_stores", {});
			_defineProperty(this, "_snapshot", null);
		}
		...
		async notifyRegistered(agentId, store) {
			await this.core.notifySubscribers((subscriber) => {
				var _subscriber$onThreadS;
				return (_subscriber$onThreadS = subscriber.onThreadStoreRegistered) === null || _subscriber$onThreadS === void 0 ? void 0 : _subscriber$onThreadS.call(subscriber, {
					copilotkit: this.core,
					agentId,
					store
				});
		...
		async notifyUnregistered(agentId, prevStore) {
			await this.core.notifySubscribers((subscriber) => {
				var _subscriber$onThreadS2;
				return (_subscriber$onThreadS2 = subscriber.onThreadStoreUnregistered) === null || _subscriber$onThreadS2 === void 0 ? void 0 : _subscriber$onThreadS2.call(subscriber, {
					copilotkit: this.core,
					agentId,
					prevStore
				});
	...
	var MemoryError = class MemoryError extends Error {
		...
		*/
		constructor(code, options) {
			var _options$message, _options$retryable;
			const entry = MEMORY_ERROR_REGISTRY[code];
			super((_options$message = options === null || options === void 0 ? void 0 : options.message) !== null && _options$message !== void 0 ? _options$message : entry.message, { cause: options === null || options === void 0 ? void 0 : options.cause });
			...
			this.retryable = (_options$retryable = options === null || options === void 0 ? void 0 : options.retryable) !== null && _options$retryable !== void 0 ? _options$retryable : entry.retryable;
...
//#region src/memory.ts
	...
	*/
	...
	function memoryFromFetch(input, init) {
		return (0, rxjs_fetch.fromFetch)(input, init);
	}
	/**
	...
	*/
	function createMemoryFetchObservable(environment, context, sessionId) {
		return (0, rxjs.defer)(() => {
			...
			}), (0, rxjs_operators.map)((data) => memoryRestEvents.listSucceeded({
				sessionId,
				memories: data.memories
			})), (0, rxjs_operators.catchError)((error) => {
				if (error instanceof MemoryRouteUnavailableError) return (0, rxjs.of)(memoryRestEvents.listUnavailable({ sessionId }));
				return (0, rxjs.of)(memoryRestEvents.listFailed({
					sessionId,
	...
	*/
	function createMemoryCredentialsFetchObservable(environment, context, sessionId) {
		return (0, rxjs.defer)(() => memoryFromFetch(`${context.runtimeUrl}${MEMORIES_SUBSCRIBE_PATH}`, {
			...
			if (error instanceof MemoryRouteUnavailableError) return (0, rxjs.of)(memoryRestEvents.credentialsUnavailable({ sessionId }));
			return (0, rxjs.of)(memoryRestEvents.credentialsFailed({
				sessionId,
				error: error instanceof Error ? error : new Error(String(error))
			}));
		})));
	...
	*/
	function toMutationBody(input) {
		var _input$sourceThreadId;
		return {
			content: input.content,
			kind: input.kind,
			...input.scope !== void 0 ? { scope: input.scope } : {},
			sourceThreadIds: (_input$sourceThreadId = input.sourceThreadIds) !== null && _input$sourceThreadId !== void 0 ? _input$sourceThreadId : []
		};
	}
	/**
	...
	*/
	...
	function createMemoryMutationObservable(environment, context, request) {
		...
		return (0, rxjs.defer)(() => memoryFromFetch(`${context.runtimeUrl}${path}`, {
			selector: async (response) => {
		...
		}), (0, rxjs_operators.mergeMap)((data) => (0, rxjs.of)(...buildMutationSuccessActions(request, data))), (0, rxjs_operators.catchError)((error) => (0, rxjs.of)(memoryRestEvents.mutationFinished({ outcome: {
	...
	*/
	function createMemoryStore(environment) {
		...
		const bootstrapEffect = createEffect((actions$, state$) => actions$.pipe(ofType(memoryAdapterEvents.contextChanged), (0, rxjs_operators.withLatestFrom)(state$), (0, rxjs_operators.filter)(([, state]) => Boolean(state.context)), (0, rxjs_operators.map)(([, state]) => memoryRestEvents.listRequested({ sessionId: state.sessionId }))));
		const credentialsBootstrapEffect = createEffect((actions$, state$) => actions$.pipe(ofType(memoryAdapterEvents.contextChanged), (0, rxjs_operators.withLatestFrom)(state$), (0, rxjs_operators.filter)(([, state]) => Boolean(state.context)), (0, rxjs_operators.map)(([, state]) => memoryRestEvents.credentialsRequested({ sessionId: state.sessionId }))));
		const credentialsFetchEffect = createEffect((actions$, state$) => actions$.pipe(ofType(memoryRestEvents.credentialsRequested), (0, rxjs_operators.switchMap)((action) => state$.pipe((0, rxjs_operators.map)((state) => state.context), (0, rxjs_operators.filter)((context) => Boolean(context)), (0, rxjs_operators.take)(1), (0, rxjs_operators.map)((context) => ({
			action,
			context
		})), (0, rxjs_operators.takeUntil)(actions$.pipe(ofType(memoryAdapterEvents.contextChanged, memoryAdapterEvents.stopped))), (0, rxjs_operators.switchMap)(({ action: currentAction, context }) => createMemoryCredentialsFetchObservable(environment, context, currentAction.sessionId))))));
		const store = createStore({
			reducer: memoryReducer,
			effects: [
				bootstrapEffect,
				credentialsBootstrapEffect,
				createEffect((actions$, state$) => actions$.pipe(ofType(memoryRestEvents.listRequested), (0, rxjs_operators.switchMap)((action) => state$.pipe((0, rxjs_operators.map)((state) => state.context), (0, rxjs_operators.filter)((context) => Boolean(context)), (0, rxjs_operators.take)(1), (0, rxjs_operators.map)((context) => ({
					action,
					context
				})), (0, rxjs_operators.takeUntil)(actions$.pipe(ofType(memoryAdapterEvents.contextChanged, memoryAdapterEvents.stopped))), (0, rxjs_operators.switchMap)(({ action: currentAction, context }) => createMemoryFetchObservable(environment, context, currentAction.sessionId)))))),
				credentialsFetchEffect,
				createEffect((actions$, state$) => actions$.pipe(ofType(memoryAdapterEvents.addRequested, memoryAdapterEvents.updateRequested, memoryAdapterEvents.removeRequested), (0, rxjs_operators.withLatestFrom)(state$), (0, rxjs_operators.mergeMap)(([action, state]) => {
					const context = state.context;
					const sessionId = state.sessionId;
					if (!(context === null || context === void 0 ? void 0 : context.runtimeUrl)) return (0, rxjs.of)(memoryRestEvents.mutationFinished({ outcome: {
				...
				createEffect((actions$, state$) => actions$.pipe(ofType(memoryRestEvents.credentialsSucceeded), (0, rxjs_operators.withLatestFrom)(state$), (0, rxjs_operators.filter)(([action, state]) => {
					var _state$context;
					return action.sessionId === state.sessionId && Boolean((_state$context = state.context) === null || _state$context === void 0 ? void 0 : _state$context.wsUrl);
				}), (0, rxjs_operators.switchMap)(([action, state]) => {
					const context = state.context;
					const { joinToken, joinCode, projectJoinToken, projectJoinCode } = action;
					const primaryJoinToken = joinToken !== null && joinToken !== void 0 ? joinToken : projectJoinToken;
					...
					const channelMetadata$ = (channelJoinToken, topic) => {
						...
						return (0, rxjs.merge)(channel$.pipe((0, rxjs_operators.switchMap)(({ channel }) => ɵobservePhoenixEvent$(channel, MEMORY_METADATA_EVENT)), (0, rxjs_operators.map)((event) => mapMemoryMetadataEvent(event, sessionId))), ɵjoinPhoenixChannel$(channel$).pipe((0, rxjs_operators.catchError)((error) => {
					...
					return (0, rxjs.defer)(() => {
						...
						const fatalSocketShutdown$ = ɵobservePhoenixSocketHealth$(ɵobservePhoenixSocketSignals$(socket$).pipe((0, rxjs_operators.share)()), MAX_SOCKET_RETRIES$1).pipe((0, rxjs_operators.catchError)(() => {
							console.warn(`[memory] WebSocket failed after ${MAX_SOCKET_RETRIES$1} attempts, giving up`);
							return (0, rxjs.of)(void 0);
						}), (0, rxjs_operators.share)());
						const fatalStatus$ = fatalSocketShutdown$.pipe((0, rxjs_operators.map)(() => memoryDomainEvents.realtimeUnavailable({ sessionId })));
						const metadata$ = channel$.pipe((0, rxjs_operators.switchMap)(({ channel }) => ɵobservePhoenixEvent$(channel, MEMORY_METADATA_EVENT)), (0, rxjs_operators.map)((event) => mapMemoryMetadataEvent(event, action.sessionId)));
						const join$ = ɵjoinPhoenixChannel$(channel$).pipe((0, rxjs_operators.concatWith)((0, rxjs.of)(memoryDomainEvents.realtimeConnected({ sessionId }))), (0, rxjs_operators.catchError)((error) => {
							console.warn(`[memory] failed to join ${primaryTopic}`, error);
							return (0, rxjs.of)(memoryDomainEvents.realtimeUnavailable({ sessionId }));
						}));
						const projectMetadata$ = joinToken && joinCode && projectJoinToken && projectJoinCode ? channelMetadata$(projectJoinToken, `project_meta:memories:${projectJoinCode}`) : rxjs.EMPTY;
						return (0, rxjs.merge)((0, rxjs.of)(memoryDomainEvents.realtimeConnecting({ sessionId })), metadata$, join$, projectMetadata$, fatalStatus$).pipe((0, rxjs_operators.takeUntil)((0, rxjs.merge)(shutdown$, fatalSocketShutdown$.pipe((0, rxjs.observeOn)(rxjs.asapScheduler)))), (0, rxjs_operators.finalize)(() => {}));
					});
				})))
			]
		});
		function trackMutation(dispatchAction, extract) {
			...
			const resultPromise = (0, rxjs.firstValueFrom)((0, rxjs.merge)(store.actions$.pipe(ofType(memoryRestEvents.mutationFinished), (0, rxjs_operators.filter)((action) => action.outcome.requestId === requestId), (0, rxjs_operators.map)((action) => action.outcome)), store.actions$.pipe(ofType(memoryAdapterEvents.stopped), (0, rxjs_operators.map)(() => ({
				requestId,
		...
		return {
			...
			refresh() {
				...
				const done = (0, rxjs.firstValueFrom)((0, rxjs.merge)(store.actions$.pipe(ofType(memoryRestEvents.listSucceeded, memoryRestEvents.listFailed, memoryRestEvents.listUnavailable), (0, rxjs_operators.filter)((action) => action.sessionId === sessionId)), store.actions$.pipe(ofType(memoryAdapterEvents.stopped)), store.actions$.pipe(ofType(memoryAdapterEvents.contextChanged))).pipe((0, rxjs_operators.take)(1))).then((action) => {
			...
			recall(query, opts) {
				...
				if (!(context === null || context === void 0 ? void 0 : context.runtimeUrl)) return Promise.reject(/* @__PURE__ */ new Error("Runtime URL is not configured"));
				const body = { query };
				if ((opts === null || opts === void 0 ? void 0 : opts.limit) !== void 0) body.limit = opts.limit;
				if ((opts === null || opts === void 0 ? void 0 : opts.scope) !== void 0) body.scope = opts.scope;
				return (0, rxjs.firstValueFrom)(memoryFromFetch(`${context.runtimeUrl}${MEMORIES_RECALL_PATH}`, {
					selector: async (response) => {
					...
					var _data$memories;
					return ((_data$memories = data.memories) !== null && _data$memories !== void 0 ? _data$memories : []).map((m) => recallResponseToMemory(m));
				})));
			},
			addMemory(input) {
	...
	*/
	...
	var CopilotKitCore = class {
		constructor({ runtimeUrl, runtimeTransport = "auto", deferInitialConnection = false, headers = {}, credentials, properties = {}, agents__unsafe_dev_only = {}, tools = [], suggestionsConfig = [], debug }) {
			...
			_defineProperty(this, "_defaultThrottleMs", void 0);
			...
			_defineProperty(this, "threadStoreRegistry", void 0);
			_defineProperty(this, "_memoryStore", void 0);
			_defineProperty(this, "previousAgentIds", /* @__PURE__ */ new Set());
		...
		*/
		syncMemoryContext() {
			...
			if (this.runtimeConnectionStatus === CopilotKitCoreRuntimeConnectionStatus.Connected && ((_this$intelligence = this.intelligence) === null || _this$intelligence === void 0 ? void 0 : _this$intelligence.wsUrl) && this.runtimeUrl) this._memoryStore.setContext({
				runtimeUrl: this.runtimeUrl,
		...
		*/
		setCatalogComponents(components) {
			...
			this.notifySubscribers((subscriber) => {
				var _subscriber$onCatalog;
				return (_subscriber$onCatalog = subscriber.onCatalogComponentsChanged) === null || _subscriber$onCatalog === void 0 ? void 0 : _subscriber$onCatalog.call(subscriber, {
					copilotkit: this,
		...
		setCatalogComponentEnabled(name, enabled) {
			...
			this.notifySubscribers((subscriber) => {
				var _subscriber$onCatalog2;
				return (_subscriber$onCatalog2 = subscriber.onCatalogComponentsChanged) === null || _subscriber$onCatalog2 === void 0 ? void 0 : _subscriber$onCatalog2.call(subscriber, {
					copilotkit: this,
					catalogComponents: this.runHandler.catalogComponents
				});
			}, "Subscriber onCatalogComponentsChanged error:");
		...
		*/
		subscribeToAgentWithOptions(agent, subscriber, options) {
			var _ref, _options$throttleMs;
			const resolved = (_ref = (_options$throttleMs = options === null || options === void 0 ? void 0 : options.throttleMs) !== null && _options$throttleMs !== void 0 ? _options$throttleMs : this._defaultThrottleMs) !== null && _ref !== void 0 ? _ref : 0;
			let effectiveMs = 0;
			if (!Number.isFinite(resolved) || resolved < 0) {
				const source = (options === null || options === void 0 ? void 0 : options.throttleMs) !== void 0 ? "throttleMs" : "defaultThrottleMs";
...
//#region src/threads.ts
	...
	function sortThreadsByRecency(threads) {
		return [...threads].sort((left, right) => {
			var _ref, _left$lastRunAt, _ref2, _right$lastRunAt;
			const leftKey = (_ref = (_left$lastRunAt = left.lastRunAt) !== null && _left$lastRunAt !== void 0 ? _left$lastRunAt : left.updatedAt) !== null && _ref !== void 0 ? _ref : left.createdAt;
			return ((_ref2 = (_right$lastRunAt = right.lastRunAt) !== null && _right$lastRunAt !== void 0 ? _right$lastRunAt : right.updatedAt) !== null && _ref2 !== void 0 ? _ref2 : right.createdAt).localeCompare(leftKey);
		});
	}
	...
	*/
	function normalizeThreadRunActivityNotification(payload) {
		var _payload$threadId, _payload$eventType, _payload$agentId, _payload$runId, _payload$latestEventI;
		const threadId = optionalString((_payload$threadId = payload.threadId) !== null && _payload$threadId !== void 0 ? _payload$threadId : payload.thread_id);
		const eventType = optionalString((_payload$eventType = payload.eventType) !== null && _payload$eventType !== void 0 ? _payload$eventType : payload.event_type);
		if (!threadId || !eventType) return null;
		return {
			type: "thread_run_activity",
			threadId,
			agentId: optionalString((_payload$agentId = payload.agentId) !== null && _payload$agentId !== void 0 ? _payload$agentId : payload.agent_id),
			runId: optionalString((_payload$runId = payload.runId) !== null && _payload$runId !== void 0 ? _payload$runId : payload.run_id),
			eventType,
			latestEventId: optionalString((_payload$latestEventI = payload.latestEventId) !== null && _payload$latestEventI !== void 0 ? _payload$latestEventI : payload.latest_event_id)
		};
	}
	const threadReducer = createReducer(initialThreadState, on(threadAdapterEvents.contextChanged, (state, { context }) => ({
		...
		if (!((_state$context = state.context) === null || _state$context === void 0 ? void 0 : _state$context.includeArchived)) return {
			...state,
	...
	*/
	...
	function threadFromFetch(input, init) {
		return new rxjs.Observable((subscriber) => {
			...
			if (signal === null || signal === void 0 ? void 0 : signal.aborted) abortRequest();
			else signal === null || signal === void 0 || signal.addEventListener("abort", abortRequest, { once: true });
			fetchImpl(input, {
				...requestInit,
			...
			return () => {
				signal === null || signal === void 0 || signal.removeEventListener("abort", abortRequest);
				abortRequest();
			};
		});
	}
	...
	function createThreadStore(environment) {
		...
		const store = createStore({
			...
			effects: [
				...
				createEffect((actions$, state$) => actions$.pipe(ofType(threadRestEvents.listSucceeded), (0, rxjs_operators.withLatestFrom)(state$), (0, rxjs_operators.filter)(([action, state]) => {
					var _state$context2;
					return action.sessionId === state.sessionId && !state.metadataCredentialsRequested && Boolean((_state$context2 = state.context) === null || _state$context2 === void 0 ? void 0 : _state$context2.wsUrl) && Boolean(state.metadataJoinCode);
				...
				createEffect((actions$, state$) => actions$.pipe(ofType(threadRestEvents.metadataCredentialsSucceeded), (0, rxjs_operators.withLatestFrom)(state$), (0, rxjs_operators.filter)(([action, state]) => {
					var _state$context3;
					return action.sessionId === state.sessionId && Boolean((_state$context3 = state.context) === null || _state$context3 === void 0 ? void 0 : _state$context3.wsUrl);
				}), (0, rxjs_operators.switchMap)(([action, state]) => {
					const context = state.context;
					...
					return (0, rxjs.defer)(() => {
						...
						return (0, rxjs.merge)(socketSignals$.pipe((0, rxjs_operators.map)((signal) => signal.type === "open" ? threadSocketEvents.opened({ sessionId: action.sessionId }) : threadSocketEvents.errored({ sessionId: action.sessionId }))), channel$.pipe((0, rxjs_operators.switchMap)(({ channel }) => ɵobservePhoenixEvent$(channel, THREADS_CHANNEL_EVENT)), (0, rxjs_operators.map)((payload) => threadSocketEvents.metadataReceived({
							...
							payload
						}))), channel$.pipe((0, rxjs_operators.switchMap)(({ channel }) => ɵobservePhoenixEvent$(channel, THREAD_RUN_ACTIVITY_CHANNEL_EVENT)), (0, rxjs_operators.map)((payload) => normalizeThreadRunActivityNotification(payload)), (0, rxjs_operators.filter)((notification) => notification !== null), (0, rxjs_operators.map)((notification) => threadSocketEvents.runActivityReceived({
							sessionId: action.sessionId,
							notification
				...
				createEffect((actions$, state$) => actions$.pipe(ofType(threadSocketEvents.metadataReceived), (0, rxjs_operators.withLatestFrom)(state$), (0, rxjs_operators.filter)(([action, state]) => {
					var _state$context4;
					return action.sessionId === state.sessionId && threadMetadataTargetsAgent(action.payload, (_state$context4 = state.context) === null || _state$context4 === void 0 ? void 0 : _state$context4.agentId);
					...
					if (action.payload.operation === "archived" && !((_state$context5 = state.context) === null || _state$context5 === void 0 ? void 0 : _state$context5.includeArchived)) return threadDomainEvents.threadDeleted({
						sessionId: action.sessionId,
				...
				createEffect((actions$, state$) => actions$.pipe(ofType(threadSocketEvents.joinFailed, threadSocketEvents.joinTimedOut, threadSocketEvents.errored, threadRestEvents.metadataCredentialsFailed), (0, rxjs_operators.withLatestFrom)(state$), (0, rxjs_operators.filter)(([action, state]) => action.sessionId === state.sessionId), (0, rxjs_operators.tap)(([action]) => {
				...
				createEffect((actions$, state$) => actions$.pipe(ofType(threadAdapterEvents.renameRequested, threadAdapterEvents.archiveRequested, threadAdapterEvents.unarchiveRequested, threadAdapterEvents.deleteRequested), (0, rxjs_operators.withLatestFrom)(state$), (0, rxjs_operators.mergeMap)(([action, state]) => {
					const sessionId = state.sessionId;
					const context = state.context;
		...
		const subscribeErrors = () => {
			...
			errorSubscription = store.actions$.pipe(ofType(threadRestEvents.mutationFinished), (0, rxjs_operators.filter)((action) => !action.outcome.ok && action.outcome.sessionId === store.getState().sessionId)).subscribe((action) => {
				if (!action.outcome.ok) {
					var _environment$onError;
					(_environment$onError = environment.onError) === null || _environment$onError === void 0 || _environment$onError.call(environment, action.outcome.error);
				}
			});
		};
		return {
			...
			stop() {
				...
				errorSubscription === null || errorSubscription === void 0 || errorSubscription.unsubscribe();
			...
			subscribeToRunActivity(callback) {
				return store.actions$.pipe(ofType(threadSocketEvents.runActivityReceived), (0, rxjs_operators.filter)((action) => action.sessionId === store.getState().sessionId), (0, rxjs_operators.map)((action) => action.notification)).subscribe(callback);
			},
			getState() {
				return store.getState();
			},
...
//#region src/interrupt-state.ts
	function toolResultContent(response) {
		...
		return JSON.stringify((_response$payload = response.payload) !== null && _response$payload !== void 0 ? _response$payload : { status: "resolved" });
	}
	var _responses = /* @__PURE__ */ new WeakMap();
	var _pending = /* @__PURE__ */ new WeakMap();
	var _sealed = /* @__PURE__ */ new WeakMap();
	var _ɵInterruptState_brand = /* @__PURE__ */ new WeakSet();
	/**
	...
	*/
	var ɵInterruptState = class {
		constructor() {
			_classPrivateMethodInitSpec(this, _ɵInterruptState_brand);
			_classPrivateFieldInitSpec(this, _responses, {});
			_classPrivateFieldInitSpec(this, _pending, null);
			_classPrivateFieldInitSpec(this, _sealed, false);
		}
		/** Return the active normalized interrupt without exposing mutable state. */
		get pending() {
			const pending = _classPrivateFieldGet2(_pending, this);
			if ((pending === null || pending === void 0 ? void 0 : pending.kind) === "standard") return {
				kind: "standard",
		...
		setLegacy(event) {
			_assertClassBrand(_ɵInterruptState_brand, this, _replace).call(this, {
				kind: "legacy",
				event
			});
		}
		...
		clear() {
			_classPrivateFieldSet2(_pending, this, null);
			_classPrivateFieldSet2(_sealed, this, false);
			for (const id of Object.keys(_classPrivateFieldGet2(_responses, this))) delete _classPrivateFieldGet2(_responses, this)[id];
		}
		/** Record a resolved response and return the next framework action. */
		resolve(payload, interruptId) {
			const pending = _classPrivateFieldGet2(_pending, this);
			if (!pending || _classPrivateFieldGet2(_sealed, this)) return { kind: "ignored" };
			if (pending.kind === "legacy") {
				_classPrivateFieldSet2(_sealed, this, true);
				return {
					kind: "legacy-resume",
					payload,
			...
			return _assertClassBrand(_ɵInterruptState_brand, this, _respond).call(this, pending.interrupts, interruptId, {
				status: "resolved",
				payload
			});
		}
		...
		cancel(interruptId) {
			...
			return _assertClassBrand(_ɵInterruptState_brand, this, _respond).call(this, pending.interrupts, interruptId, { status: "cancelled" });
		}
	};
	function _replace(pending) {
		this.clear();
		_classPrivateFieldSet2(_pending, this, pending);
	}
	function _respond(interrupts, interruptId, response) {
		var _interrupts$;
		const id = interruptId !== null && interruptId !== void 0 ? interruptId : (_interrupts$ = interrupts[0]) === null || _interrupts$ === void 0 ? void 0 : _interrupts$.id;
		if (!id || !interrupts.some((interrupt) => interrupt.id === id)) return { kind: "ignored" };
		_classPrivateFieldGet2(_responses, this)[id] = response;
		if (!interrupts.every((interrupt) => _classPrivateFieldGet2(_responses, this)[interrupt.id])) return { kind: "waiting" };
		const expired = interrupts.find((interrupt) => (0, _ag_ui_client.isInterruptExpired)(interrupt));
		if (expired) {
			_classPrivateFieldSet2(_sealed, this, true);
			return {
				kind: "expired",
		...
		const resume = (0, _ag_ui_client.buildResumeArray)(mutableInterrupts, _classPrivateFieldGet2(_responses, this));
		const toolResults = mutableInterrupts.flatMap((interrupt) => {
			if (!interrupt.toolCallId || interrupt.reason !== "tool_call") return [];
			return [{
				toolCallId: interrupt.toolCallId,
				content: toolResultContent(_classPrivateFieldGet2(_responses, this)[interrupt.id])
			}];
		});
		_classPrivateFieldSet2(_sealed, this, true);
		return {
...
//#region src/inspector-thread-bridge.ts
	...
	function getEventTarget() {
		...
		(_sharedGlobal$__COPIL = sharedGlobal.__COPILOTKIT_INSPECTOR_THREAD_EVENT_TARGET__) !== null && _sharedGlobal$__COPIL !== void 0 || (sharedGlobal.__COPILOTKIT_INSPECTOR_THREAD_EVENT_TARGET__ = new EventTarget());
...
exports.INSPECTOR_THREAD_BRIDGE_PLUGIN_ID = INSPECTOR_THREAD_BRIDGE_PLUGIN_ID;
exports.IntelligenceAgent = IntelligenceAgent;
exports.MEMORY_ERROR_REGISTRY = MEMORY_ERROR_REGISTRY;
...
exports.createInspectorThreadRequestId = createInspectorThreadRequestId;
exports.createReducer = createReducer;
exports.createSelector = createSelector;
exports.createStore = createStore;
exports.emitInspectorActiveThread = emitInspectorActiveThread;
exports.emitInspectorStopViewing = emitInspectorStopViewing;
exports.emitInspectorViewThread = emitInspectorViewThread;
exports.emitInspectorViewThreadResult = emitInspectorViewThreadResult;
exports.empty = empty;
exports.ensureObjectArgs = ensureObjectArgs;
exports.isAbortError = isAbortError;
exports.isInspectorThreadBridgeEnabled = isInspectorThreadBridgeEnabled;
exports.isRunCompletionAware = isRunCompletionAware;
exports.ofType = ofType;
exports.on = on;
exports.onInspectorActiveThread = onInspectorActiveThread;
exports.onInspectorStopViewing = onInspectorStopViewing;
exports.onInspectorViewThread = onInspectorViewThread;
exports.onInspectorViewThreadResult = onInspectorViewThreadResult;
exports.parseToolArguments = parseToolArguments;
exports.props = props;
exports.select = select;
exports.ɵCOPILOTKIT_FEATURES = ɵCOPILOTKIT_FEATURES;
exports.ɵInterruptState = ɵInterruptState;
exports.ɵMAX_SOCKET_RETRIES = ɵMAX_SOCKET_RETRIES;
exports.ɵcreateMemoryStore = createMemoryStore;
exports.ɵcreateThreadSelectors = ɵcreateThreadSelectors;
exports.ɵcreateThreadStore = createThreadStore;
exports.ɵisCopilotKitFeature = ɵisCopilotKitFeature;
exports.ɵisRetryableMemoryStatus = isRetryableStatus;
exports.ɵjoinPhoenixChannel$ = ɵjoinPhoenixChannel$;
exports.ɵmapMemoryMetadataEvent = ɵmapMemoryMetadataEvent;
exports.ɵmemoryAdapterEvents = ɵmemoryAdapterEvents;
exports.ɵmemoryDomainEvents = ɵmemoryDomainEvents;
exports.ɵmemoryReducer = ɵmemoryReducer;
exports.ɵmemoryRestEvents = ɵmemoryRestEvents;
...
exports.ɵselectFetchMoreError = ɵselectFetchMoreError;
exports.ɵselectHasNextPage = ɵselectHasNextPage;
exports.ɵselectIsFetchingNextPage = ɵselectIsFetchingNextPage;
exports.ɵselectIsMutating = ɵselectIsMutating;
exports.ɵselectMemories = ɵselectMemories;
exports.ɵselectMemoriesAvailable = ɵselectMemoriesAvailable;
exports.ɵselectMemoriesError = ɵselectMemoriesError;
exports.ɵselectMemoriesIsLoading = ɵselectMemoriesIsLoading;
exports.ɵselectMemoriesIsMutating = ɵselectMemoriesIsMutating;
exports.ɵselectMemoriesRealtimeStatus = ɵselectMemoriesRealtimeStatus;

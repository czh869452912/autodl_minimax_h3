...
export type ChannelTool<Schema extends ObjectSchema = ObjectSchema> = {
     ...
     */
    handler(args: InferSchemaOutput<Schema>, ctx: ChannelToolContext): Promise<unknown> | unknown;
};
/**
 ...
 * ```
 */
export declare function defineChannelTool<Schema extends ObjectSchema>(tool: ChannelTool<Schema>): ChannelTool<Schema>;
...
export declare function toAgentToolDescriptors(tools: ReadonlyArray<ChannelTool>): AgentToolDescriptor[];

...
export interface PlatformAdapter {
     ...
     */
    addReaction?(target: ReplyTarget, messageRef: MessageRef, emoji: EmojiValue): Promise<{
        ok: boolean;
        error?: string;
    }>;
    removeReaction?(target: ReplyTarget, messageRef: MessageRef, emoji: EmojiValue): Promise<{
        ok: boolean;
        error?: string;
    }>;
    /**
     ...
     */
    openModal?(target: ReplyTarget, triggerId: string, ir: ChannelNode[]): Promise<{
        ok: boolean;
        error?: string;
    }>;
}

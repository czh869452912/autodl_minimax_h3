...
const cellsOf = (ir) => renderBlockKit(ir)[0].rows;
describe("renderBlockKit", () => {
    ...
    describe("table cells", () => {
        ...
        it("promotes a markdown link with bold label to a rich_text cell", () => {
            const [, body] = cellsOf(table(["Issue"], [`[**CPK-1234**](${ISSUE_URL})`]));
            expect(body).toEqual([
                {
                    type: "rich_text",
                    elements: [
        ...
        it("renders mixed runs in one cell", () => {
            const [, body] = cellsOf(table(["Mixed"], [`**bold** plain \`code\` — [unstyled link](${ISSUE_URL})`]));
            expect(body).toEqual([
                {
                    type: "rich_text",
                    elements: [

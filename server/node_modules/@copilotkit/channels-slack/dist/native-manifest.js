...
const OBJECTS = "https://docs.slack.dev/reference/block-kit/composition-objects/";
/**
 ...
 */
export const SLACK_UNTYPED_OBJECTS = new Set([
    "confirm",
    "conversation_filter",
...
function entries(rows, kind, source) {
...
export const SLACK_NATIVE_MANIFEST = [

...
describe('native app shell contract', () => {
  ...
  it('provides readable text for light surfaces and filled primary buttons', () => {
    ...
    for (const [foreground, background] of [[COLORS.text, COLORS.background], [COLORS.textMuted, COLORS.surface], [COLORS.textSubtle, COLORS.surface], [COLORS.textSubtle, COLORS.surfaceRaised], [COLORS.onPrimary, COLORS.primary], [COLORS.primaryActive, COLORS.primarySoft]]) {

...
const styles = StyleSheet.create({ section: { gap: SPACING.sm, marginTop: SPACING.md }, sectionLabel: { color: COLORS.textMuted, fontSize: 12, fontFamily: 'monospace' }, imageGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: SPACING.sm }, imageCard: { width: '31%', aspectRatio: 1, borderRadius: 12, overflow: 'hidden', backgroundColor: COLORS.background, borderWidth: 1, borderColor: COLORS.border }, image: { width: '100%', height: '100%' }, imageTag: { position: 'absolute', left: 6, top: 6, color: COLORS.onPrimary, backgroundColor: COLORS.mediaOverlay, paddingHorizontal: 5, paddingVertical: 2, borderRadius: 5, fontSize: 11 }, remove: { position: 'absolute', right: 0, bottom: 0, width: 48, height: 48, borderRadius: 8, backgroundColor: COLORS.danger, alignItems: 'center', justifyContent: 'center' }, audioRow: { minHeight: 58, flexDirection: 'row', alignItems: 'center', gap: SPACING.sm, padding: SPACING.sm, backgroundColor: COLORS.background, borderWidth: 1, borderColor: COLORS.border, borderRadius: 12 }, audioTag: { backgroundColor: COLORS.surfaceRaised, borderRadius: 6, paddingHorizontal: 7, paddingVertical: 5 }, tagText: { color: COLORS.primaryActive, fontSize: 11, fontFamily: 'monospace', fontWeight: '700' }, audioCopy: { flex: 1 }, name: { color: COLORS.text, fontSize: 13 }, meta: { color: COLORS.textSubtle, fontSize: 11, marginTop: 3 }, iconButton: { width: 48, height: 48, alignItems: 'center', justifyContent: 'center' } });

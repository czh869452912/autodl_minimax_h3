import { userFacingError, mediaDownloadErrorMessage } from '../media/mediaValidation';
...
const styles = StyleSheet.create({
  ...
  downloadText: { color: COLORS.textMuted, fontSize: 12, lineHeight: 19, flexGrow: 1, flexShrink: 1, flexBasis: 120 },
  ...
  remove: { minHeight: 48, justifyContent: 'center', alignSelf: 'flex-end', marginTop: 12, paddingHorizontal: 14, borderRadius: 12, borderWidth: 1, borderColor: COLORS.border },

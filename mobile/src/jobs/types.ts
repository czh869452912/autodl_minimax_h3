...
export type JobRecord = { id: string; workflowId: string; workflowVersion: string; workflowContentHash: string; adapterId: string; adapterVersion: string; inputSnapshot: Record<string, unknown>; remote?: { providerJobId?: string; rawStatus?: string }; status: JobStatus; error?: NormalizedError; createdAt: number; updatedAt: number; startedAt?: number; executionDuration?: number };

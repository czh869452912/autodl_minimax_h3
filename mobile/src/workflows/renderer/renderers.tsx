...
const styles = StyleSheet.create({
  ...
  chip: { flexGrow: 1, flexBasis: 140, maxWidth: '100%', minHeight: 48, paddingVertical: 12, paddingHorizontal: 10, borderRadius: 8, alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.surfaceRaised, borderWidth: 1, borderColor: COLORS.controlBorder },
  selectedChip: { borderColor: COLORS.primaryActive, backgroundColor: COLORS.primarySoft },
  chipText: { textAlign: 'center', color: COLORS.textMuted, fontSize: 13 },
  selectedText: { color: COLORS.primaryActive, fontWeight: '800' },
  durationRow: { flexDirection: 'row', alignItems: 'center', gap: SPACING.sm },
  step: { minWidth: 48, minHeight: 48, padding: 8, borderRadius: 8, alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.surfaceRaised, borderWidth: 1, borderColor: COLORS.controlBorder },
  stepText: { color: COLORS.primaryActive, fontSize: 23 },
  durationInput: { flex: 1, minWidth: 0, textAlign: 'center', fontSize: 17, fontWeight: '800' },

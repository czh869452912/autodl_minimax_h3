export type ArtifactErrorCode =
  ...
  | 'ARTIFACT_COMPATIBILITY_BUSY'
  | 'ARTIFACT_COMPATIBILITY_SOURCE_MISSING'
  | 'ARTIFACT_COMPATIBILITY_HDR_UNSUPPORTED'
  | 'ARTIFACT_CAS_BUSY'
...
const RETRYABILITY: Record<ArtifactErrorCode, boolean> = {
  ...
  ARTIFACT_COMPATIBILITY_FAILED: false, ARTIFACT_COMPATIBILITY_HDR_UNSUPPORTED: false,
  ARTIFACT_COMPATIBILITY_BUSY: true,
  ARTIFACT_COMPATIBILITY_SOURCE_MISSING: false,
};

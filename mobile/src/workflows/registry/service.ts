...
// Frozen extension service; application bootstrap uses packageVerification directly.
import { RegistryError, isWorkflowCompatible, parseVerifiedWorkflowPackage, canonicalizePackage, type WorkflowPackageSource, type VerifiedWorkflowPackage } from './packageVerification';
export { RegistryError, isWorkflowCompatible, parseVerifiedWorkflowPackage, type WorkflowCompatibilityContext } from './packageVerification';

...
export default function SettingsScreen() {
  ...
  return <KeyboardAvoidingView style={styles.container} behavior="padding" keyboardVerticalOffset={insets.top}><ScrollView ref={scrollRef} onLayout={revealFocusedInput} style={styles.container} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag">
    ...
    <WorkflowSyncPanel />
    <DataManagementPanel />
  </ScrollView><View style={styles.saveBar}>
